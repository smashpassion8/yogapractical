...
@Component({
  selector: 'gravitypose',
  templateUrl: './gravitypose.component.html',
  styleUrls: ['./gravitypose.component.css']
})
export class GravityposeComponent implements OnInit {
  ...
  reloadData() {
    this.asanaService.getGravityPoseList().subscribe(
      data => {
        this.asanaCat = data;
        console.log(data);
