...
@Component({
  selector: 'app-pranayam-p',
  templateUrl: './pranayam-p.component.html',
  styleUrls: ['./pranayam-p.component.css']
})
export class PranayamPComponent implements OnInit {
  ...
  constructor(private asanaService: AsanaService, private appComp : AppComponent) {
    ...
    appComp.title = "Pranayam Practice";
   }
  ...
  reloadData() {
    this.asanaService.getPranayamPracticeList().subscribe(
      data => {
        this.asanaCat = data;
