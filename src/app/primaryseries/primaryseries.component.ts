...
@Component({
  selector: 'primaryseries',
  templateUrl: './primaryseries.component.html',
  styleUrls: ['./primaryseries.component.css']
})
export class PrimarySeriesComponent implements OnInit {
  ...
  constructor(private asanaService: AsanaService, private appComp : AppComponent) {
    ...
    appComp.title = "Ashtang Yoga Primary Series";
   }
  ...
  reloadData() {
    ...
    // this.asanaCat = this.asanaService.getAsanaList();
    // console.log(this.asanaService.getAsanaList());
  }
