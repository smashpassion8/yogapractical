...
@Component({
  selector: 'app-gravitypose-p',
  templateUrl: './gravitypose-p.component.html',
  styleUrls: ['./gravitypose-p.component.css']
})
export class GravityposePComponent implements OnInit {
  ...
  constructor(private appComp : AppComponent) {
    ...
    appComp.title = "Gravity Poses Practice";
   }
